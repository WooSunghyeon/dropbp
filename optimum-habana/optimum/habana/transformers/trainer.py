...
class GaudiTrainer(Trainer):
    ...
    def __init__(
        ...
        measure_time: Optional[bool]=None,
    ...
    def training_step(self, model: torch.nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]], step: int) -> torch.Tensor:
        """
