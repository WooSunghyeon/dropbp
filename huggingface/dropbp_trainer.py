...
class DropBPTrainer(Trainer):
    def __init__(self,
                ...
                drop_rate=0.5, 
                is_sens_alloc=True,):
        super(DropBPTrainer, self).__init__(model, args, data_collator, train_dataset, eval_dataset, tokenizer, model_init, compute_metrics, callbacks, optimizers, preprocess_logits_for_metrics)
        self.drop_rate=drop_rate
        self.is_sens_alloc = is_sens_alloc
        
    # DropBP Step 2. Set the target drop rate     
    def dropbp_initialize(self):
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if step == int(max_steps*args.gradient_accumulation_steps*0.1):
    ...
    def train_dropbp(self, resume_from_checkpoint, trial=None, ignore_keys_for_eval=None):
        self.dropbp_initialize()
        self.train(resume_from_checkpoint, trial, ignore_keys_for_eval) 
        return